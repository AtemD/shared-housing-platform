...
class CreateCompatibilityPreferencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('compatibility_preferences', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('compatibility_preferences');
    }
}
