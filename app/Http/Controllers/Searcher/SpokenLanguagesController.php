...
class SpokenLanguagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('searcher/basic-profile/index', compact('user'));
    }
    ...
    {
        return view('searcher/spoken-languages/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('searcher.basic-profile.index')->with('success', 'Spoken Language Created Successfully');
    }
    ...
    public function edit(SpokenLanguage $spoken_language)
    {
        ...
        return view('searcher/spoken-languages/edit', compact('spoken_language'));
    }
