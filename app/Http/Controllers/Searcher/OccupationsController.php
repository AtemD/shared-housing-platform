...
class OccupationsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('searcher/basic-profile/occupation/index', compact('user'));
    }
    ...
    {
        return view('searcher/occupations/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('searcher.basic-profile.index')->with('success', 'Occupation Created Successfully');
    }
    ...
    public function edit(Occupation $occupation)
    {
        ...
        return view('searcher/occupations/edit', compact('occupation'));
    }
