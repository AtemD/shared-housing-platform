...
class MatchSearcherWithListersJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // 5. Calculate compatibility percentage between the two users
        // 6. Store the result in the matches table, user_id, matched_user_id, compatibility_percentage
