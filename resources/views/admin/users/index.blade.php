                                ...
                                <form role="form" method="GET" action="{{ route('admin.users.index') }}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 d-flex justify-content-end mt-4">
                                            <div class="form-group">
                                                <a class="btn btn-outline-secondary mt-2" href="{{ route('admin.users.index') }}">Reset Filters</a>
                                            </div>
                                        </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-secondary">{{ $user->type }}</span></td>
                                    ...
                                    <td class="project-actions">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.users.edit', $user->slug) }}" role="button">
