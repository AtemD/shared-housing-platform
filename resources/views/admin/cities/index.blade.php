                        ...
                        <tbody>
                            @forelse($cities as $city)
                                <tr>
                                    ...
                                    <td>
                                        {{$countries[$city->region->country]}}
                                    </td>
                                    <td class="project-actions">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.cities.edit', ['city' => $city]) }}" role="button">
                                        ...
                                        <div class="modal fade" id="delete-city-{{$city->id}}" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{ route('admin.cities.destroy', ['city' => $city]) }}">
                                                        @method('DELETE')
                                                        @csrf
