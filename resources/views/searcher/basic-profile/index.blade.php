    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('searcher.basic-profile.update', ['basic_profile' => $user->basicProfile->id]) }}">
                        @method('PUT')
                        @csrf
                    ...
                    <div class="card card-default card-outline card-primary mt-4 shadow">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-8 d-flex justify-content-end">
                                    <a href="{{ route('searcher.occupations.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered delete-occupation-{{$occupation->id}}">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form role="form" method="POST" action="{{ route('searcher.occupations.destroy', ['occupation' => $occupation->id]) }}">
                                                        @method('DELETE')
                                                        @csrf
                                ...
                                <div class="col-3">
                                    <a href="{{ route('searcher.occupations.edit', ['occupation' => $occupation->id ]) }}" class="btn btn-block btn-primary btn-sm">
                    ...
                    <div class="card card-default card-outline card-primary mt-4 shadow">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 d-flex justify-content-end">
                                    <a href="{{ route('searcher.spoken-languages.create') }}" class="btn btn-sm btn-primary">
                                        <i class="fas fa-plus xs"></i> {{ __('Add New') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered delete-spoken-language-{{$spoken_language->id}}">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form role="form" method="POST" action="{{ route('searcher.spoken-languages.destroy', ['spoken_language' => $spoken_language->id]) }}">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger">Yes, Delete</button>
                                                    </form>
                                ...
                                <div class="col-3">
                                    <a href="{{ route('searcher.spoken-languages.edit', ['spoken_language' => $spoken_language->id ]) }}" class="btn btn-block btn-primary btn-sm">
                                        <i class="fas fa-pencil-alt"></i> {{ __('Edit') }}
                                    </a>
                                </div>
                            </div>
