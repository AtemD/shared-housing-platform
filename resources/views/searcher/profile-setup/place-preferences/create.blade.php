    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('searcher.profile-setup.place-preferences.store') }}">
                        @csrf
                        ...
                        <small class="text-muted">Select the city and localities you want to find a place in.</small>
                        <div class="form-group">
                            ...
                            <select name="city" class="form-control @error('city') is-invalid @enderror" id="city" required>
                                ...
                                <div class="alert alert-warning" role="alert">
                                    No cities cities to show for now!
                                </div>
                                @endforelse
                            </select>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                <a href="{{ route('searcher.profile-setup.basic-profile.create') }}" class="btn btn-warning">{{ __('<< Back') }}</a>
