            ...
            <div class="card card-primary card-outline card-outline-tabs border-left-0 border-right-0 border-bottom-0 shadow-none">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('searcher.matches.users.index') }}" role="tab" aria-selected="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('searcher.matches.places.index') }}" role="tab" aria-selected="false">
                ...
                <div class="card-body px-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="{{route('searcher.matches.users.show', $person->slug)}}" class="stretched-link">
                                <div class="card">
