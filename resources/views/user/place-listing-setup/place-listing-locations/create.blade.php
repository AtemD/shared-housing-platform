        ...
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                <div class="card-header">
                    <h5><span class="badge badge-primary text-wrap">(Step 2/3)</span> <b>{{ __('Add Place Listing Location') }}</b></h4>
                    ...
                    <form method="POST" action="{{ route('user.place-listing-setup.place-listing-locations.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="city" class="form-control @error('city') is-invalid @enderror" id="city" required>
                                ...
                                {{ (old('city') == $city->id) || (session('place_listing_setup.place_listing_location.city') == $city->id) ? 'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                                @empty
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                <a href="{{ route('user.place-listing-setup.place-listings.create') }}" class="btn btn-warning">{{ __('<< Back') }}</a>
