    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.personal-preferences.update', $personal_preference) }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="diet_habit_{{$key}}" name="diet_habit" class="custom-control-input @error('diet_habit') is-invalid @enderror" value="{{$key}}" {{ old('diet_habit')== $key || $personal_preference->diet_habit == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="smoking_habit_{{$key}}" name="smoking_habit" class="custom-control-input @error('smoking_habit') is-invalid @enderror" value="{{$key}}" {{ old('smoking_habit')== $key || $personal_preference->smoking_habit == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="alcohol_habit_{{$key}}" name="alcohol_habit" class="custom-control-input @error('alcohol_habit') is-invalid @enderror" value="{{$key}}" {{ old('alcohol_habit')== $key || $personal_preference->alcohol_habit == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="partying_habit_{{$key}}" name="partying_habit" class="custom-control-input @error('partying_habit') is-invalid @enderror" value="{{$key}}" {{ old('partying_habit')== $key || $personal_preference->partying_habit == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="guest_habit_{{$key}}" name="guest_habit" class="custom-control-input @error('guest_habit') is-invalid @enderror" value="{{$key}}" {{ old('guest_habit')== $key || $personal_preference->guest_habit == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="marital_status_{{$key}}" name="marital_status" class="custom-control-input @error('marital_status') is-invalid @enderror" value="{{$key}}" {{ old('marital_status')== $key || $personal_preference->marital_status == $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="occupation_type_{{$key}}" name="occupation_type" class="custom-control-input @error('occupation_type') is-invalid @enderror" value="{{$key}}" {{ old('occupation_type')== $key || $personal_preference->occupation_type == $key  ? 'checked' : '' }}>
