    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.place-listing.amenities.update', $place_listing->slug) }}">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="amenities[]" value="{{$amenity->id}}" class="form-check-input" id="add-amenity-{{$amenity->id}}" {{ (is_array(old('amenities')) && in_array($amenity->id, old('amenities'))) || ($place_listing->amenities->contains($amenity->id)) ? ' checked' : '' }}>
