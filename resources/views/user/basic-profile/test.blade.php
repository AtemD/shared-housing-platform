                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <label for="gender">Gender</label>
                                <select class="custom-select form-control" id="gender" name="gender" disabled>
                                    <option value="">Gender...</option>
                                    @forelse(App\References\Gender::genderList() as $key => $gender)
                                        <option value="{{$key}}" {{ $basic_profile->gender == $key ? 'selected' : '' }}>{{$gender}}</option>
                                    @empty 
                                        <option value="">Error...</option>
                                    @endforelse
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <label for="dob">Date of Birth</label>
                                <input type="date" class="form-control" id="dob" name="dob" value="{{ $basic_profile->dob }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <label for="validationTextarea">Bio</label>
                                <textarea class="form-control" id="validationTextarea" placeholder="Briefly write about yourself" rows="3" name="bio" disabled>{{ $basic_profile->bio }}</textarea>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-end">
                            <a href="{{ route('user.basic-profile.edit', $basic_profile) }}" class="btn btn-primary">{{ __('Edit >>') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
