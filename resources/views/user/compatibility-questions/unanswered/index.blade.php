            ...
            <div class="card card-primary card-outline card-outline-tabs border-left-0 border-right-0 border-bottom-0 shadow-none">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="in-progress-tab" href="{{route('user.compatibility-questions.unanswered.index')}}" role="tab" aria-controls="in-progress" aria-selected="false">
                            <i class="fa-solid fa-circle-question"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="new-tab" href="{{route('user.compatibility-questions.answered.index')}}" role="tab" aria-controls="new" aria-selected="false">
