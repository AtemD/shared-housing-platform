    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.place-preferences.update', $user->placePreference->id) }}">
                        @method('PUT')
                        @csrf
        ...
        <div class="col-md-6">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.place-preference-locations.update', 12) }}">
                        @method('PUT')
                        @csrf
