...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white pl-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('user.places.index') }}">Place s</a></li>
            <li class="breadcrumb-item"><a href="{{ route('user.places.show', $place_location->place->slug) }}">{{$place_location->place->slug}}</a></li>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.place-locations.update', $place_location->id) }}">
                        @method('PUT')
                        @csrf
