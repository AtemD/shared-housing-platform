    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('lister.personal-preferences.store') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <a href="{{ route('lister.places.create') }}" class="btn btn-warning">{{ __('<< Back') }}</a>
                                @elsecan('create', App\Models\PlacePreference::class)
                                <a href="{{ route('lister.place-preferences.create') }}" class="btn btn-warning">{{ __('<< Back') }}</a>
                                @endcan
