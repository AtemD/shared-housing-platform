    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="list-group">
                <a href="{{ route('lister.places.edit', $place->slug) }}" class="list-group-item list-group-item-action">
                    <div class="row">
                ...
                <a href="{{ route('lister.place-locations.edit', $place->placeLocation->id) }}" class="list-group-item list-group-item-action">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-between">
                ...
                <a href="{{ route('lister.place.amenities.edit', $place->slug) }}" class="list-group-item list-group-item-action">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-between">
