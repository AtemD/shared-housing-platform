            ...
            <div class="card card-primary card-outline card-outline-tabs border-left-0 border-right-0 border-bottom-0 shadow-none">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="received" href="{{route('lister.place-requests.received.index')}}" role="tab" aria-controls="received" aria-selected="false">
                                <i class="fas fa-inbox"></i> Received
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="sent" href="{{route('lister.place-requests.sent.index')}}" role="tab" aria-controls="sent" aria-selected="false">
