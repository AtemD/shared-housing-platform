            ...
            <div class="card card-primary card-outline card-outline-tabs border-left-0 border-right-0 border-bottom-0 shadow-none">
                <div class="card-header p-0 border-bottom-0">
                    <ul class="nav nav-tabs nav-justified" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="unanswered" href="{{route('lister.compatibility-questions.unanswered.index')}}" role="tab" aria-controls="unanswered" aria-selected="false">
                                <i class="fa-solid fa-circle-question"></i> Unanswered
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" id="answered" href="{{route('lister.compatibility-questions.answered.index')}}" role="tab" aria-controls="answered" aria-selected="false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <form method="POST" action="{{ route('lister.compatibility-questions.update', ['compatibility_question' => $compatibility_question->slug]) }}">
                                            @method('PUT')
                                            @csrf
