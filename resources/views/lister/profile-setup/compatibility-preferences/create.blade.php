    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('lister.profile-setup.compatibility-preferences.store') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                <a href="{{ route('lister.profile-setup.personal-preferences.create') }}" class="btn btn-warning">{{ __('<< Back') }}</a>
