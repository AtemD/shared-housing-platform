@if($user->type == \App\References\UserType::LISTER)
<div class="row">
                ...
                <div class="col-md-8">
                    <div class="card-body pt-1">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('lister.matches.places.show', $place->id) }}" class="btn btn-outline-primary stretched-link">View Details</a>
                        </div>
                    </div>
                </div>
            </div>
