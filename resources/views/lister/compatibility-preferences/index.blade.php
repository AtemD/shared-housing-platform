...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white">
            ...
            <li class="breadcrumb-item active" aria-current="page">Compatibility Preference</li>
        </ol>
    </nav>
</div>
<div class="container">
        ...
        <div class="col-md-5">
            <div class="card card-default card-outline card-primary mt-4 shadow">
                <div class="card-header">
                    <h5><b>{{ __('Compatibility Preferences') }}</b></h4>
                        <small class="text-muted">These are the habits that you want in a potential match.</small>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('lister.compatibility-preferences.update', $compatibility_preference->id) }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="alert alert-warning" role="alert">
                                There are no Diet Habits to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Smoking Habits to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Alcohol Habits to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Partying Habits to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Guest Habits to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Marital Status to show.
                            </div>
                            @endforelse
                        ...
                        <div class="form-group row">
                            ...
                            @empty
                            <div class="alert alert-warning" role="alert">
                                There are no Occupation Type to show.
                            </div>
                            @endforelse
